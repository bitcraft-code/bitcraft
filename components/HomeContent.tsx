        ...
        >
          ...
          <span
            ...
            style={{
              ...
              background: `radial-gradient(circle 200px at ${headerMouse.x}px ${headerMouse.y}px, ${dark ? "rgba(255,255,255,0.22)" : "rgba(0,170,255,0.22)"}, transparent 70%)`,
            }}
          />
          {/* Border spotlight */}
          <span
          ...
          <div className="flex items-center gap-3 sm:gap-4">
                ...
                >
                  ...
                  <span
                    ...
                    style={{
                      ...
                      background: `radial-gradient(circle 60px at ${navSpotlight.x}px ${navSpotlight.y}px, ${dark ? "rgba(255,255,255,0.25)" : "rgba(0,170,255,0.25)"}, transparent 70%)`,
                    }}
                  />
                  {/* Border spotlight */}
                  <span
            ...
            >
              ...
              <span className="absolute inset-0 rounded-full pointer-events-none overflow-hidden" style={{ opacity: s.active ? 1 : 0, transition: spT(s.active), background: `radial-gradient(circle 50px at ${s.pos}, ${dark ? "rgba(255,255,255,0.25)" : "rgba(0,170,255,0.25)"}, transparent 70%)` }} />
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center flex-1 px-5 pb-8 pt-4 sm:px-6 sm:pb-16 sm:pt-8 gap-4 sm:gap-6 md:gap-8">
        ...
        >
          ...
          <RotatingText
            ...
            overlay={(() => { const s = sp(pillSpotlight.hover, pillSpotlight.x, pillSpotlight.y); return (<>
                <span className="absolute inset-0 rounded-lg pointer-events-none overflow-hidden" style={{ opacity: s.active ? 1 : 0, transition: spT(s.active), background: `radial-gradient(circle 160px at ${s.pos}, ${dark ? "rgba(255,255,255,0.25)" : "rgba(0,170,255,0.25)"}, transparent 70%)` }} />
        ...
        >
          ...
          >
            ...
            <span className="absolute inset-0 rounded-full pointer-events-none overflow-hidden" style={{ opacity: s.active ? 1 : 0, transition: spT(s.active), background: `radial-gradient(circle 80px at ${s.pos}, ${dark ? "rgba(255,255,255,0.22)" : "rgba(0,170,255,0.22)"}, transparent 70%)` }} />
