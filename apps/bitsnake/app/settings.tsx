...
export default function TemplateSettingsScreen() {
  ...
  return (
    <GameShell
      title={t("settings.title") + " — Bitsnake"}
    ...
    >
      ...
      <SectionCard title="Preferences">
        ...
        <ToggleRow
          label="Show debug"
          description="Example of a bitsnake-specific setting."
      ...
      <SectionCard title="Mock monetization">
        <Text style={{ color: colors.textMuted, fontSize: 14, lineHeight: 20 }}>
          The bitsnake already includes the monetization contract, without forcing a real SDK from day one.
        </Text>
